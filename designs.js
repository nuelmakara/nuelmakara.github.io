...
*The '<td>' has an event listener that attaches the 
*selected colorPicker value to the <td> element when clicked! on('click');
*The Css style gets applied to the <td> onClick event and on doubleClick removes (.removeAttr()) 
*from the style attribute from the <td> element.
*/
...
*@deacription A while loop is used to loop through the different values of .inputHeight and .inputWidth so 
*that a corresponding grid of rows and cols can be drawn.
*/
